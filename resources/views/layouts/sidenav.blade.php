<nav class="grey darken-3">
    <div class="nav-wrapper">
      ...
      <ul class="side-nav grey darken-2" id="mobile-demo">
        ...
        <li class="white"><a href="#" class="waves-effect waves-blue">Feedback</a></li>
        <li class="white"><a href="#" class="waves-effect waves-blue">About Us</a></li>
        <li class="white"><a href="#" class="waves-effect waves-blue">Reset Password</a></li>
        <li class="white"><div class="divider"></div></li>
        <li class="red accent-1"><a href="{{route('logout')}}" class="waves-effect waves-blue">Log Out</a></li>
